...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        public override void Fire(float spreadMultiplier = 1.0f)
        {
            ...
            //If there's something blocking, then aim directly at that thing.
            ...
            // If no target was hit, register a missed shot
            if (!hitTarget)
            {
                var targetScript = Object.FindFirstObjectByType<TargetScript>();
                targetScript?.RegisterShot();
            }

            //Spawn projectile from the muzzle socket
